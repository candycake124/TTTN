<content>
	        ...
	        <div class="modal-content">
	          <div class="modal-body">
	            ...
	            <h4>Thêm Sản Phẩm</h4>
	              ...
	              <br>
	            <input class="btn login" onclick="return checksp();" name="login" type="submit" value="Submit" />
	            </form>
	          </div>
	        </div>
	      </div>  
  ...
  <table class="table table-bordered table-striped">
	...
	<tr>
	<form method="post">
		<td><p><?php echo $dem; ?></p><input type="" style="display: none;" name="id_sp" value="<?php echo $value['id_sp']; ?>"></td>
		<td>
